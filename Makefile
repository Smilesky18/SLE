...
debug: main_GP.cpp
	g++ -g lib/super_lu.cpp lib/lu_dense.cpp lib/lu_gp.cpp lib/lu_gp_amd.cpp lib/lu_gp_v2.cpp lib/lu_gp_v3.cpp lib/readMatrix.cpp main_GP.cpp lib/microtime.cpp lib/lu_sparse.cpp -fpermissive /usr/local/lib/libamd.a /usr/local/lib/libsuitesparseconfig.a -lsuperlu -lblas -lm -o main_GP.g
clean:
	rm -rf  main main_GP.g
